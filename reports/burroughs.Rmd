...
```{r burroughs-poly, fig.cap = "Burroughs Direct Seeding Polygon with Hillshade from 1m LiDAR DEM", fig.height = 5,  fig.width = 6}
...
```{r burroughs-soil, fig.cap = "Burroughs Soil Water Holding Capacity (WHC, mm) at 25 cm soil depth.", fig.height = 5, fig.width = 6}
...
```{r heat-load, fig.height = 5, fig.width = 6}
library(reticulate)
...
```{r, burroughs-baseline, fig.cap = "Burroughs Historical Water Balance (2002-2022)", fig.height = 5, fig.width = 6}
...
``` {r, burroughs-drought-year, fig.cap="Burroughs Drought Year (1988) annual AET and CWD", fig.height = 5, fig.width = 6}
...
``` {r, projections-aet-hot-wet, fig.height = 5, fig.width = 6}
aet_hot_wet_plot

```

``` {r, projections-aet-warm-dry, fig.height = 5, fig.width = 6}
aet_warm_dry_plot

```

``` {r, projections-cwd-warm-dry, fig.height = 5, fig.width = 6}
cwd_warm_dry_plot

```

``` {r, projections-cwd-hot-dry, fig.height = 5, fig.width = 6}
cwd_hot_dry_plot
...
```{r, burroughs-climate-summary, fig.height = 6, fig.width = 7, fig.cap = "Burroughs Climate summaries.  AET and CWD distributions for all 1m pixels in the avalanche polygon are shown for 1988 (Drought Year), 2002-2022 (Historical Baseline), and 2075-2099 projections for 'Warm/Wet', 'Warm/Dry', 'Hot/Wet', 'Hot/Dry' scenarios"}
