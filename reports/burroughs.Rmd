...
```{r burroughs-poly, fig.cap = "Burroughs Direct Seeding Polygon with Hillshade from 1m LiDAR DEM"}
...
```{r burroughs-soil, fig.cap = "Burroughs Soil Water Holding Capacity (WHC, mm) at 25 cm soil depth."}
...
```{r, burroughs-baseline, fig.cap = "Burroughs Historical Water Balance (2002-2022)"}
...
``` {r, burroughs-drought-year, fig.cap="Burroughs Drought Year (1988) annual AET and CWD"}
...
```{r, burroughs-climate-summary, fig.height = 6, fig.width = 8, fig.cap = "Burroughs Climate summaries.  AET and CWD distributions for all 1m pixels in the avalanche polygon are shown for 1988 (Drought Year), 2002-2022 (Historical Baseline), and 2075-2099 projections for 'Warm/Wet', 'Warm/Dry', 'Hot/Wet', 'Hot/Dry' scenarios"}
